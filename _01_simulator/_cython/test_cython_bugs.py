...
from _01_simulator import simulate, state, engine
...
from _01_simulator.action_space import legal_action_mask_tensor, action_index
...
def main():
    ...
    py_state2, arr2 = test_after_one_step(py_state, arr)
